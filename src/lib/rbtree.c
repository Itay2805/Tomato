 ...
 */
static inline void __rb_rotate_set_parents(rb_node_t* old, rb_node_t* new, rb_root_t* root,
                                           int color) {
...
[[clang::always_inline]]
static inline void __rb_insert(rb_node_t* node, rb_root_t* root,
 ...
 */
[[clang::always_inline]]
static inline void ____rb_erase_color(rb_node_t* parent, rb_root_t* root,
                                      void (*augment_rotate)(rb_node_t* old, rb_node_t* new)) {
    rb_node_t *node = nullptr, *sibling, *tmp1, *tmp2;
...
void __rb_erase_color(rb_node_t* parent, rb_root_t* root,
                      void (*augment_rotate)(rb_node_t* old, rb_node_t* new)) {
...
static const struct rb_augment_callbacks dummy_callbacks = { .propagate = dummy_propagate,
                                                             .copy = dummy_copy,
                                                             .rotate = dummy_rotate };
...
void __rb_insert_augmented(rb_node_t* node, rb_root_t* root,
                           void (*augment_rotate)(rb_node_t* old, rb_node_t* new)) {
...
static rb_node_t* rb_left_deepest_node(const rb_node_t* node) {
    for (;;) {
        if (node->rb_left)
            node = node->rb_left;
